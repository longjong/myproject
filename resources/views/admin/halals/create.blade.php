...
@section('content')
    ...
    <div class="container mt-5">
        <div class="row m-3">
            ...
            @endif
            <form action="{{route('admin.halals.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group my-3">
                            <strong>Name Restaurant</strong>
                            <input type="text" name="name" class="form-control" placeholder="Name Restaurant">
                            @error('name')
